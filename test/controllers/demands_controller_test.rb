...
class DemandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create demand" do
    assert_difference('Demand.count') do
      post demands_url, params: { demand: { city: @demand.city, code: @demand.code, dueDate: @demand.dueDate, owner: @demand.owner, type: @demand.type } }
    end
  ...
  test "should update demand" do
    patch demand_url(@demand), params: { demand: { city: @demand.city, code: @demand.code, dueDate: @demand.dueDate, owner: @demand.owner, type: @demand.type } }
