...
class SupervisorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supervisor" do
    assert_difference('Supervisor.count') do
      post supervisors_url, params: { supervisor: { name: @supervisor.name, region_id: @supervisor.region_id } }
    end
  ...
  test "should update supervisor" do
    patch supervisor_url(@supervisor), params: { supervisor: { name: @supervisor.name, region_id: @supervisor.region_id } }
